...
// Open form
echo form_open_multipart(base_url('member/dasbor/posting/tambah'));
?>
<div class="col-md-8">
...
<div class="col-md-4">
<div class="form-group form-group-lg">
<label>Kategori<sup> <a href="<?php echo base_url('member/dasbor/kategori_posting') ?>" class="btn btn-primary btn-xs"><i class="fa fa-plus"></i></a></sup></label>
